...
export default function Hero() {
  return (
    <>
      <div className="hero min-h-full bg-gradient-to-b from-[#011638] to-[#011028] border-2 border-yellow-700 ">
        <div className="hero-content flex-col lg:flex-row-reverse ">
          {/* img section  */}
          <div className="drop-shadow-2xl animate-fadeinright border-2 border-green-600">
            <div>
              <Donut
                color="#f43f5e"
                size="180px"
          ...
          <div className="flex flex-col">
            <div className="bg-gradient-to-r from-[#E8C547] to-[#E8C547] rounded-lg p-10 z-50 drop-shadow-lg w-4/4 md:w-2/4">
              <h1
